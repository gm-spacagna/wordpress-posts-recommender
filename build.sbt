...
libraryDependencies ++= Seq(
  ...
  "org.apache.spark" % "spark-core_2.10" % "1.5.1" withSources() withJavadoc(),
  "org.apache.spark" % "spark-sql_2.10" % "1.5.1" withSources() withJavadoc(),
  "org.apache.spark" % "spark-mllib_2.10" % "1.5.1" withSources() withJavadoc(),
